...
BEGIN
    ...
    BEGIN
        ...
        -- CT7: reset durante reproducao -> audio=0 e LEDs=0 apos soltar tecla
        caso <= 7;
        ASSERT false REPORT "CT7: reset durante reproducao" SEVERITY note;
        botoes_s <= "00000001";
        WAIT FOR 2 * T;
        aplica_reset;
        -- solta tecla para que UC permaneca em idle e permitir checar saidas zeradas
        solta_tecla;
        ...
        ASSERT hex0_s = SEG_OFF REPORT "CT7 FALHOU: display nao apagado apos reset" SEVERITY error;
